...
import com.example.social_ft.R;
...
public class TwitterDialog extends Dialog {
	...
	private String mUrl;
	private TwitterApp.OnTwitterAuthListener mListener;
	...
	public TwitterDialog(Context context, String url,
			TwitterApp.OnTwitterAuthListener listener) {
		super(context);
	...
	private class TwitterWebViewClient extends WebViewClient {
		...
		public boolean shouldOverrideUrlLoading(WebView view, String url) {
			if (url.startsWith(TwitterApp.CALLBACK_URL)) {
				mListener.onTwitterAuthComplete(url);
		...
		public void onReceivedError(WebView view, int errorCode,
			...
			mListener.onTwitterAuthError(description);
			TwitterDialog.this.dismiss();
		}
